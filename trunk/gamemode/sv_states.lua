...
GM.STATES[STATE_NONE].Think = function( self )
end
...
-- Preparing States
GM.STATES[STATE_PREPARING].Start = function( self )
end

GM.STATES[STATE_PREPARING].Think = function( self )
end

GM.STATES[STATE_PREPARING].End = function( self )
end
...
GM.STATES[STATE_PLAYING].End = function( self )
end
